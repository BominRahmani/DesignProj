        ...
        <group name="Sketchfab_model" position={[0, 0, 0]} rotation={[-Math.PI / 2, 0, Math.PI]}>
          <group name="root">
            <group name="GLTF_SceneRootNode" rotation={[Math.PI / 2, 0, 0]}>
              <group name="Dizzy_Space_0" position={[0.09, 0.79, -0.02]} scale={0.4}>
                ...
                <group name="Nave_2" position={[-0.09, -0.79, -860]} scale={10}>
                  ...
                  <mesh name="Object_7" geometry={nodes.Object_7.geometry} materials={materials.Nave} />
                </group>
